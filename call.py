...
def run(idx):
  ...
  kwargs = {'dtype': dtype,
            'device': device,
            'requires_grad': True}
  input_batchnorm = torch.randn(128, 10000, 256, **kwargs)
  ...
  def upsample_input():
    ...
    #  yield input_upsample
  im2col_input = torch.randn(1, 3, 2512, 2048, **kwargs)
